    ...
    return (
        <div className='listDoctors'>
            {currentDataDoctors.map((doctor) => (
                <Link to="#" className="group relative block overflow-hidden" key={doctor.id}>
                  <button
                  ...
                  <div className="relative border border-gray-100 bg-white p-6">
                    <span className="whitespace-nowrap bg-gray-400 px-3 py-1.5 text-xs font-medium"> {doctor.major} </span>
                
                    <h3 className="mt-4 text-lg font-medium text-gray-900">{doctor.fullName}</h3>
